    ...
    return (
        <div className="container">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-4">
                ...
                <div class="col">
                    <div class="card">
                        <img src="https://i.ibb.co/qd1VWB8/images-removebg-preview.png" alt="" />
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="https://i.ibb.co/BTFHzVv/2454556-removebg-preview.png" alt="" />
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="https://i.ibb.co/qDQSptb/207-2071237-customer-service-icon-customer-service-flat-icon-png-removebg-preview.png" alt="" />
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="https://i.ibb.co/16H2q02/5221076-removebg-preview.png" alt="" />
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card">
                        <img src="https://i.ibb.co/Mn74YZr/1024px-Archlinux-icon-crystal-64-svg-removebg-preview.png" alt="" />
                        <div class="card-body">
